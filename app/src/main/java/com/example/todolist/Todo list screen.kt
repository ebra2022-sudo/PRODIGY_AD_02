...
fun TodoScreen(
    ...
    Scaffold(
        ...
        if (todoViewModel.showBottomSheet) {
            ModalBottomSheet(
                onDismissRequest = {
                    todoViewModel.closeBottomSheet()
                },
                ...
                Column(
                    ...
                    HorizontalDivider(modifier = Modifier.fillMaxWidth(), thickness = 2.dp, color =MaterialTheme.colorScheme.onSecondaryContainer)
                    // Sheet content
                    ...
                    Column(modifier = Modifier
                        ...
                        TextField(
                            value = todoViewModel.description,
                            onValueChange = todoViewModel.onDescriptionChange,
                            modifier = Modifier.fillMaxWidth()
                        )
                    }
                    Column(modifier = Modifier
                        ...
                        Text(text = "Duration")
                        TextField(
                            value = todoViewModel.duration,
                            onValueChange = todoViewModel.onDurationChange,
                            modifier = Modifier.fillMaxWidth(),
...
@Composable
fun ScreenSetUp(mainViewModel: TodoViewModel) {
    val allProducts by mainViewModel.todos.observeAsState(listOf())
    TodoScreen(todoViewModel = mainViewModel, allProducts = allProducts)
}
